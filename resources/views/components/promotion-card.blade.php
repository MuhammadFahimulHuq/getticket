...
<div class="basis-1/5 rounded-lg border border-gray-200 shadow-md bg-white">
   ...
   <div class="px-5 py-3">
    ...
    <div class="flex justify-center my-2">
        <a class="inline-flex items-center py-2 px-16 text-sm font-medium font-bold text-center text-white bg-slate-700 rounded-sm hover:bg-slate-800 focus:ring-3 focus:outline-none focus:ring-slate-300 dark:bg-slate-600 dark:hover:bg-blue-slate dark:focus:ring-slate-800" href="/promotion/addtocart/{{$promotion->id}}">Add to cart
